                ...
                <table class="list_tab">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a onclick="delCate({{$v->link_id}})" href="javascript:;">删除</a>
                        </td>
                    </tr>
...
<!--搜索结果页面 列表 结束-->
    <script>
        function changeOrder(obj,link_id){
            $.post('{{url('admin/links/change_order')}}',{'_token':'{{csrf_token()}}','link_order': obj.value,'link_id':link_id}, function (data) {
                if(data.status==0){
